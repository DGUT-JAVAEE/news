...
<html>
 <head>
 	...
 	<script type="text/javascript">
 	  function deleteANews(id){
		ids1=document.getElementById("ids"); 
	  	...
	  	document.getElementById('myform').action="${pageContext.request.contextPath }/newsServlet?type1=deleteANews";
	  ...
	  function editsANew(id){
		ids1=document.getElementById("ids"); 
	  	...
	  	//提交
	  	document.getElementById('myform').setAttribute("target","_blank");
	  	document.getElementById('myform').action="${pageContext.request.contextPath }/newsServlet?type1=editANews";
		document.getElementById('myform').submit();
	  }	
      ...
      function getOnePage(type){
    	  	...
    	  	document.getElementById('myform').action="${pageContext.request.contextPath }/newsServlet?type1=manageNews";    	  	
    	  	document.getElementById('myform').submit();
      	}
	</script>  
  </head>
  ...
  <body>
  	<form action="${pageContext.request.contextPath }/newsServlet?type1=manageNews" id="myform" method="post">
  	 <table align="center"  class="tableDefault"  style="width:600px;">
	    <tr style="background-color:#FFACAC;">
	      <td style="width:350px">标题</td>
	 ...
	 <table align="center" class="tableDefault" style="margin-bottom: 10px">     
	   	<tr>			
