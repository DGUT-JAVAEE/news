...
<html>
  ...
  <body>
   <div class="div-out"> 
	<form action="${pageContext.request.contextPath }/newsServlet?type1=edit&newsId=${requestScope.news.newsId}" 
	...
	<script type="text/javascript">	
		...
		function cancel(){//取消修改 
			ids1=document.getElementById("ids"); 
		  	ids1.value="";
		  	//提交
		  	document.getElementById('myform').action="${pageContext.request.contextPath }/newsServlet?type1=newsManage";
