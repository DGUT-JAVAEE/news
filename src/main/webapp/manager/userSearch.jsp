...
<html>
 <head><meta charset="utf-8">
   ...
   <body>
	<form action="${pageContext.request.contextPath }/userServlet?type1=search&page=1&pageSize=2" method="post">
		<table width="500" border="0" align="center">
			<tbody><tr height="40"><td></td><td>查询条件</td></tr>
				<tr >
				...
				<tr height="40">
					<td></td><td><input type="submit" value="  开 始 查 询   "/></td>
				</tr>
			</tbody>
		</table>
	</form>    
