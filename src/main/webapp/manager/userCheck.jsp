...
<html>
 <head>
  ...
  <body>
  	<form action="${pageContext.request.contextPath }/userServlet?type1=check" id="myform" method="post">
  	 <table align="center" class="tableDefault" style="width:550px;"  >
	    <tr style="background-color:#FFACAC;">
	      ...
	      <td><a href='javascript:void(0);' onclick="getOnePage('','enable');">可用性</a></td>
	      <td>切换可用性</td>
	    </tr>	    
	    <c:forEach items="${requestScope.users}"  var="user">      
	   		<tr class="trDefault">
		   		...
		   		<td>${user.type}</td>	
		   		<td>${user.name}</td>     
		   		<td><myTag:TimestampTag dateTime="${user.registerDate}" type="YMDHMS-"/> </td>	
