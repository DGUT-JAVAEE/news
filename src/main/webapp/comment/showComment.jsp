...
<html>
 <head>
	...
	<script type="text/javascript">
      ...
      function getOnePage(type){
      	...
      	function praise(commentId,newsId){
      		document.getElementById('myform').action="${pageContext.request.contextPath }/commentServlet?type=praise&"
      	...
      	function model(commentId){
      		document.getElementById('myModel').innerHTML=
      			"<form action='${pageContext.request.contextPath }/commentServlet?type=addCommnet' method='post'> \
  ...
  <body>
	<form action="${pageContext.request.contextPath }/newsServlet?type1=showANews&newsId=${param.newsId}" id="myform" method="post">
